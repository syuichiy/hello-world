...
- 🤖 **取り崩し方針をAIに相談**：取り崩し戦略タブの「🤖 AIに方針を相談」で、**画面に出ている試算値そのもの**（前提・集中銘柄・3方式の資産寿命と成功確率・暴落シナリオ）をClaudeに渡し、〈おすすめの方針／その理由／逆を選んだ場合／見落としやすい点〉を返します。サーバで計算し直さないので、**画面の数字とAIのコメントが食い違いません**。前提を変えて再計算すると古い助言は消えます（設定でAIをオンにしている場合のみボタンが出ます）
