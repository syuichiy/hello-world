...
SEED_FUNDS = [
    ...
    # --- auアセットマネジメント ---
    {"name": "auAMレバレッジ NASDAQ100（為替ヘッジ無し）",
     "isin": "JP90C000QZ77", "assoc_code": "AY311247",
     "category": "米国株式（NASDAQ・レバレッジ）"},
    ...
    {"name": "SBI・S・米国高配当株式ファンド（年4回決算型）（S・米国高配当株式100）",
     "isin": "JP90C000REE2", "assoc_code": "8931224C", "category": "米国株式（高配当）"},
...
SEED_ASSET_CLASS = {
    ...
    "AY311247": "高リターン",   # auAMレバレッジ NASDAQ100（為替ヘッジ無し・2倍）
